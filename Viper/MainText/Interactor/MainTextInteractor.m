...
{
    [self.output bringPresenterNewsText:[self getCorrectStringByNewsID:newsID]];
}

- (void)getTitleForID:(NSUInteger)newsID
{
    [self.output bringTitle:[self getTitleByNewsID:newsID]];
}

#pragma mark - Helper

- (NSString *)getTitleByNewsID:(NSUInteger)newsID
{
    switch (newsID) {
        case 1: {
            return @"Lorem ipsum";
...
- (NSString *)getCorrectStringByNewsID:(NSUInteger)newsID
{
    switch (newsID) {
        case 1: {
            return [self loreimText];
        } break;
        case 2: {
            return [self myText];
        } break;
