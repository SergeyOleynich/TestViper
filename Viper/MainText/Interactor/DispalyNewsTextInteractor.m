...
{
    NewsDomainModule *model = [NewsDomainModule new];
    model.newsId = newsID;
    model.newsTitle = [self news].allKeys[[model.newsId integerValue]];
    model.newsText = [self news][model.newsTitle];
    
    [self.output dataIsReady:model];
}
